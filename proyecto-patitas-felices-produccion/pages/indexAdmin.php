            ...
            <?php
                if (!isset($_SESSION['user'])){
                    ...
                    ?>
                                  ...
                                  <div class="col-md-10 col-md-offset-2">
                                    <div class="block">
                                      <h1 class="animated fadeInUp">Administrar tablas</h1>
                                          <a class="btn btn-default btn-call-to-action" href="modelo/adopcion/readAdopcion.php">Adopcion de mascota</a>
                                          <a class="btn btn-default btn-call-to-action" href="modelo/mascota/readMascota.php">Mascota</a>	      	      
                                          ...
                                          <a class="btn btn-default btn-call-to-action" href="modelo/administrador/readAdmin.php">Administrador</a>	 
						...
						<a class="btn btn-default btn-call-to-action" href="modelo/ciudad/readciudad.php">Ciudad</a>
						<a class="btn btn-default btn-call-to-action" href="modelo/museo/readmuseo.php">Museo</a>	           
                                    </div>
                                  </div>
                                </div>
                              </div>
