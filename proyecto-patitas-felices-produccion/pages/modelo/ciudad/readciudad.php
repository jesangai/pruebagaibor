    ...
    if($_SESSION['rol']==2){
                ...
                <html class="no-js">
                  <head>
                    ...
                    <title>Administrador - CIUDAD- Patitas felices</title>
                  ...
                  <header>
                    ...
                    <table id="tabla">
                        ...
                        <?php
                            ...
                            echo "<tr>";
                            echo "<td>" . $c->getId_ciudad() . "</td>";
                            echo "<td>" . $c->getNombre() . "</td>";   




                            echo "<td><a href='updateciudad.php?id_ciudad=" . $c->getId_ciudad() . "&nombre=" . $c->getNombre() . "'><button class='btn btn-default btn-call-to-action'>Editar</button></a>  </td>"	;



                            echo "<td> <a href='deleteciudad.php?id_ciudad=". $c->getId_ciudad() ."'>
