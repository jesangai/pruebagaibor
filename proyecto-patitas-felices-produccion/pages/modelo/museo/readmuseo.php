...
if (isset($_SESSION['user'])){
                      ...
                      <div class="container">
                        <div class="row">
                          <div class="col-md-10 col-md-offset-2">
                            <div class="block">
                              <h1>Tabla museo</h1>
                    <a href="createmuseo.php"><button class="btn btn-default btn-call-to-action">Crear museo</button></a> <br>
                    <table id="tabla">
                        <tr>    
                            <th>&nbsp;&nbsp;id_museo&nbsp;&nbsp;</th>
                            <th>&nbsp;&nbsp;nombre&nbsp;&nbsp;</th>
  ...
  echo "<td>" . $c->getId_ciudad() . "</td>"; 
                            ...
                            echo "<td> <a href='deletemuseo.php?id_museo=". $c->getId_museo() ."'>
